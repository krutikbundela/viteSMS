          ...
          <Grid item xs={12} sm={6} md={4}>
            <StyledPaper elevation={3}>
              <div onClick={() => navigateHandler("Student")}>
                ...
                Login as a student to explore class dettails , attendance and
                marks.
              </div>
            </StyledPaper>
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
            <StyledPaper elevation={3}>
              <div onClick={() => navigateHandler("Teacher")}>
                ...
                Login as a teacher to explore class details, take student&apos;s
                attendance, give marks.
              </div>
            </StyledPaper>
          </Grid>
        </Grid>
